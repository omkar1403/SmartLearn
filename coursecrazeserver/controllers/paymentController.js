...
const plan_id = process.env.PLAN_ID || "plan_NUetoORgf9GCb3";
...
export const paymentVerification=catchAsyncError(async(req,res,next)=>{
    ...
    res.redirect(`${process.env.FRONTEND_URL}/paymentsuccess?references=${razorpay_payment_id}`);
    
    })

    export const getRezorpaykey=catchAsyncError(async(req,res,next)=>{
        res.status(200).json({
            success:true,
