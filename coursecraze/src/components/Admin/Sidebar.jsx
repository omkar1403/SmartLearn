...
import { RiAddCircleFill, RiDashboardFill, RiEye2Fill, RiUser3Fill } from 'react-icons/ri'
...
const location=useLocation();
  ...
  return (
    <VStack spacing={'8'} padding={'16'} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'}>
     ...
     <LinkButton Icon={RiEye2Fill} text={'Courses'} url={'courses'} active={location.pathname==="/admin/courses"}/>
